...
;;;;  To play simply call "play-events" on any list of events, or put the events into *events* 
;;;;  and (play-events *events*) as in
#| (play-events (compose-new-music-based-on-markovian-probabilities 
   60 
   5 
